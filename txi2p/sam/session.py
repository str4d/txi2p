...
class SAMSession(object):
    def __init__(self, samEndpoint, nickname, style, id, proto, autoClose):
...
def getSession(nickname, samEndpoint=None, autoClose=False, **kwargs):
    ...
    def createSession((style, id, proto, pubKey)):
        s = SAMSession(samEndpoint, nickname, style, id, proto, autoClose)
